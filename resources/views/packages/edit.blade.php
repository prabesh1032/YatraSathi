    ...
    <div class="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ $package->name }}" class="mt-1 block w-full
                 border border-gray-300 rounded-md shadow-sm focus:border-indigo-500
            ...
            <div class="mb-4">
                ...
                <textarea name="description" class="mt-1 block w-full border border-gray-300
