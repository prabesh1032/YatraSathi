...
<div class="flex items-center justify-between mb-6">
    <div>
        <h2 class="text-lg font-semibold text-blue-950">Create Package</h2>
        <p class="text-sm text-gray-500 mt-0.5">Add a new tour package for travellers to explore.</p>
    </div>
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="starting_location" name="starting_location" value="{{ old('starting_location') }}"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="duration" class="block text-sm font-semibold text-blue-950 mb-1.5">
                            <i class="ri-time-line text-orange-500 mr-1"></i>Duration (days) <span class="text-orange-500">*</span>
                        </label>
                    ...
                    <div>
                        <label for="price" class="block text-sm font-semibold text-blue-950 mb-1.5">
                            <i class="ri-money-dollar-circle-line text-orange-500 mr-1"></i>Price ($) <span class="text-orange-500">*</span>
                        </label>
                ...
                <div>
                    ...
                    <input type="text" id="transportation" name="transportation" value="{{ old('transportation') }}"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="meals" name="meals" value="{{ old('meals') }}"
                            class="w-full px-4 py-2.5 rounded-lg border border-gray-200 text-gray-800 bg-gray-50 placeholder-gray-400 focus:ring-2 focus:ring-orange-400 focus:border-orange-400 focus:bg-white outline-none transition-all duration-200"
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <label for="photopath" id="upload-area"
                        class="flex flex-col items-center justify-center w-full h-56 px-4 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 hover:bg-orange-50/40 hover:border-orange-300 transition-colors duration-200 cursor-pointer text-center">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="8"
                        ...
                        placeholder="Describe the tour package in detail — what's included, highlights, itinerary...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1.5"><i class="ri-error-warning-line mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
