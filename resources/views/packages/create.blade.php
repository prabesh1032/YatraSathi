    ...
    <div class="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" name="photopath" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                @error('photopath')
                    <div class="text-red-600 mt-2 text-sm">
                        *{{$message}}
                    </div>
