...
<header class="relative h-screen bg-cover bg-center">
    <img src="{{ asset('contact-bg.jpg') }}" alt="Header Image" class="absolute inset-0 w-full h-full object-cover z-0">
    ...
    <div class="relative container mx-auto h-full flex flex-col justify-center items-center text-center text-white">
        ...
        <a href="#contact-form" class="mt-6 px-5 py-3 bg-yellow-500 text-black font-bold rounded-full hover:bg-yellow-600 ">CONTACT US</a>
    </div>
</header>
