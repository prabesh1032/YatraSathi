...
<div class="mt-20" id="contact-form">
    ...
    <div class="container mx-auto mb-12 text-center">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <!-- Email Section -->
            <div class="p-6 rounded-lg shadow-lg bg-gray-50 hover:shadow-2xl transition-all duration-300 group">
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-2xl font-semibold text-black mb-4">Email</h3>
            ...
            <div class="p-6 rounded-lg shadow-lg bg-gray-50 hover:shadow-2xl transition-all duration-300 group">
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-2xl font-semibold text-black mb-4">Phone</h3>
            ...
            <div class="p-6 rounded-lg shadow-lg bg-gray-50 hover:shadow-2xl transition-all duration-300 group">
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-2xl font-semibold text-black mb-4">Follow Us</h3>
    ...
    <div class="container mx-auto">
        <h2 class="text-3xl font-extrabold text-center mb-6 text-gray-800">Reach Out to Us - <span class="text-yellow-500">We are Here for You!</h2>
        ...
        <form action="{{ route('contact.store') }}" method="POST" class="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300">
            @csrf
            <div class="mb-4">
                <label for="name" class="block text-lg font-medium mb-2">Name</label>
                <input type="text" id="name" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500" required>
            </div>
            <div class="mb-4">
                <label for="email" class="block text-lg font-medium mb-2">Email</label>
                <input type="email" id="email" name="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500" required>
            </div>
            <div class="mb-4">
                <label for="message" class="block text-lg font-medium mb-2">Message</label>
                <textarea id="message" name="message" class="w-full px-4 py-2 border border-gray-300 rounded-lg h-32 focus:ring-2 focus:ring-yellow-500" required></textarea>
            </div>
