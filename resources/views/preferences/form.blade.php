            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('preferences.store') }}" method="POST" class="bg-white rounded-2xl shadow-md p-8">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            @foreach ($destinations as $destination)
                                <label
                                    class="flex items-center gap-3 p-3 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 cursor-pointer transition-all duration-200">
                            ...
                            @php
                                $travelStyles = [
                                    'adventure' => [
                                        ...
                                        'title' => 'Adventure',
                                        'desc' => 'Hiking, trekking, extreme sports',
                                    ],
                                    'relaxation' => [
                                        'icon' => 'ri-leaf-line',
                                        'title' => 'Relaxation',
                                        'desc' => 'Spa, beaches, peaceful retreats',
                                    ],
                                    'cultural' => [
                                        'icon' => 'ri-government-line',
                                        'title' => 'Cultural',
                                        'desc' => 'Museums, heritage sites, traditions',
                                    ],
                                    'family' => [
                                        'icon' => 'ri-group-line',
                                        'title' => 'Family Fun',
                                        'desc' => 'Kid-friendly, safe environments',
                                    ],
                                    'romantic' => [
                                        'icon' => 'ri-heart-2-line',
                                        'title' => 'Romantic',
                                        'desc' => 'Couples retreats, intimate settings',
                                    ],
                                ];
                            @endphp
                            @foreach ($travelStyles as $key => $style)
                                <label
                                    class="flex items-start gap-4 p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 cursor-pointer transition-all duration-200">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            @php
                                $budgets = [
                                    'budget' => [
                                        'title' => 'Budget',
                                        'range' => 'Up to Rs. 150',
                                        'desc' => 'Affordable options',
                                    ],
                                    'standard' => [
                                        'title' => 'Standard',
                                        'range' => 'Rs. 150 - Rs. 400',
                                        'desc' => 'Good value packages',
                                    ],
                                    'luxury' => [
                                        'title' => 'Luxury',
                                        'range' => 'Rs. 400+',
                            ...
                            @foreach ($budgets as $key => $budget)
                                <label
                                    class="p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 cursor-pointer text-center transition-all duration-200">
                                    <input type="radio" name="budget_range" value="{{ $key }}"
                                        class="mb-2 accent-blue-900" {{ old('budget_range') == $key ? 'checked' : '' }}>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-3 md:grid-cols-5 gap-3">
                            @foreach ([3, 5, 7, 10, 14] as $duration)
                                <label
                                    class="p-3 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 cursor-pointer text-center transition-all duration-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                        <div>
                            ...
                            <select name="accommodation_type"
                                ...
                                <option value="hotel" {{ old('accommodation_type') == 'hotel' ? 'selected' : '' }}>
                                    Hotel</option>
                                <option value="resort" {{ old('accommodation_type') == 'resort' ? 'selected' : '' }}>
                                    Resort</option>
                                <option value="homestay" {{ old('accommodation_type') == 'homestay' ? 'selected' : '' }}>
                                    Homestay</option>
                                <option value="camping" {{ old('accommodation_type') == 'camping' ? 'selected' : '' }}>
                                    Camping</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="text-center pt-4 border-t border-gray-100">
                        ...
                        <p class="text-gray-400 text-xs mt-3" style="font-family: 'Plus Jakarta Sans', sans-serif;">
