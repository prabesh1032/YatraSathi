...
<div class="flex items-center justify-between mb-6">
    <div>
        <h2 class="text-lg font-semibold text-blue-950">Add New Guide</h2>
        <p class="text-sm text-gray-500 mt-0.5">Register a new tour guide and assign them to a package.</p>
    </div>
    ...
    <form action="{{ route('guides.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="6"
                        ...
                        placeholder="Brief bio — languages spoken, specialties, certifications..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1.5"><i class="ri-error-warning-line mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-semibold text-blue-950 mb-1.5">
                        <i class="ri-image-line text-orange-500 mr-1"></i>Guide Photo <span class="text-orange-500">*</span>
                    </label>
        ...
        <div class="flex justify-end gap-3 pt-5 mt-5 border-t border-gray-100">
            ...
            <button type="submit"
                ...
                <i class="ri-save-line"></i> Add Guide
            </button>
        </div>
